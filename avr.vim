...
syn match avrInclude   "\.includepath\>"
" C preprocessor:
syn match avrInclude   "#include\>"
...
syn case match
" IO registers names
syn keyword avrIOReg    SREG SPH SPL GIMSK GIFR 
"TIMSK 
syn keyword avrIOReg    TIMSK0
syn keyword avrIOReg    TIFR MCUCR MCUSR
"syn keyword avrIOReg    TCCR0
syn keyword avrIOReg    TCCR0A TCCR0B 
syn keyword avrIOReg    TCNT0 TCCR1A TCCR1B TCNT1H TCNT1L 
syn keyword avrIOReg    OCR0A OCR0B
syn keyword avrIOReg    OCR1AH OCR1AL OCR1BH OCR1BL ICR1H ICR1L
syn keyword avrIOReg    TCCR2 TCNT2 OCR2 ASSR WDTCR
syn keyword avrIOReg    GTCCR
